...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        ...
        make_option('-t', '--theme', default=settings.PINAX_THEME, dest='theme', metavar='DIR',
            help="Use this Tint theme as a the basis."
        )
    )
    help = 'Collect media files from installed apps, Tint and project in a single media directory.'
    args = '[appname ...]'
    ...
    def handle(self, *app_labels, **options):
        ...
        tint_media_root = os.path.join(settings.PROJECT_ROOT, 'media', theme)
        ...
        for location in (tint_media_root, project_media_root):
