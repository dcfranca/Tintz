...
MEDIA_ROOT = os.path.join(settings.PROJECT_ROOT, 'media', settings.PINAX_THEME)
PROJECT_MEDIA_ROOT = os.path.join(settings.PROJECT_ROOT, 'media')
TINT_APP_MEDIA_DIRS = ('media', 'static', 'site_media')
...
def get_media_path(path):
    ...
    for location in (SITE_MEDIA_ROOT, PROJECT_MEDIA_ROOT, MEDIA_ROOT):
    ...
    for app in settings.INSTALLED_APPS:
        ...
        for media_dir in TINT_APP_MEDIA_DIRS:
